...
trait FileCompare
{
    ...
    private function compareClassPhp($resourcesDir, $namespace, $className, $directoryOutput, $createIfNotExist = false)
    {
        ...
        $cresolver->setOptions(['level' => null, 'fixers' => '']);
        ...
        $fileActual2 = $iFile->getPathname();
        $actual = file_get_contents($fileActual2);
